...
{
    public class UtilizatorSocietate
    {
        const string _TABLE_NAME = "utilizatori_societati";
        ...
        public UtilizatorSocietate() { }

        public UtilizatorSocietate(int _authenticatedUserId, string _connectionString)
        {
            authenticatedUserId = _authenticatedUserId;
            connectionString = _connectionString;
        }

        public UtilizatorSocietate(int _authenticatedUserId, string _connectionString, int _ID)
        {
            authenticatedUserId = _authenticatedUserId;
            connectionString = _connectionString;
            DataAccess da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_SOCIETATIsp_GetById", new object[] { new MySqlParameter("_ID", _ID) });
            MySqlDataReader r = da.ExecuteSelectQuery();
            while (r.Read())
            {
                IDataRecord item = (IDataRecord)r;
                UtilizatorSocietateConstructor(item);
                break;
            }
            r.Close(); r.Dispose();
        }

        public UtilizatorSocietate(int _authenticatedUserId, string _connectionString, IDataRecord item)
        {
            authenticatedUserId = _authenticatedUserId;
            connectionString = _connectionString;
            UtilizatorSocietateConstructor(item);
        ...
        public void UtilizatorSocietateConstructor(IDataRecord item)
        {
        ...
        public response Insert()
        {
            ...
            var col = CommonFunctions.table_columns(authenticatedUserId, connectionString, "utilizatori_societati");
            ...
            DataAccess da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_SOCIETATIsp_insert", _parameters.ToArray());
        ...
        public response Update()
        {
            ...
            DataAccess da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_SOCIETATIsp_update", _parameters.ToArray());
        ...
        public response Delete()
        {
            ...
            {
                _parameters.Add(new MySqlParameter("_ID", this.ID));
                da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_SOCIETATIsp_delete", _parameters.ToArray());
            }
            else
            {
                ...
                da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_SOCIETATIsp_deleteByFields", _parameters.ToArray());
            }
        ...
        {
            return CommonFunctions.HasChildrens(authenticatedUserId, connectionString, this, "utilizatori_societati", tableName);
        }

        public response HasChildren(string tableName, int childrenId)
        {
            return CommonFunctions.HasChildren(authenticatedUserId, connectionString, this, "utilizatori_societati", tableName, childrenId);
        }
