...
namespace SOCISA.Models
{
    public class UtilizatorSocietateAdministrata
    {
        ...
        public response Delete()
        {
            ...
            {
                _parameters.Add(new MySqlParameter("_ID", this.ID));
                da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_SOCIETATI_ADMINISTRATEsp_delete", _parameters.ToArray());
            }
            else
            {
                ...
                da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_SOCIETATI_ADMINISTRATEsp_deleteByFields", _parameters.ToArray());
            }
