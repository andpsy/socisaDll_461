...
namespace SOCISA.Models
{
    public class UtilizatorAction
    {
        ...
        public response Delete()
        {
            ...
            {
                _parameters.Add(new MySqlParameter("_ID", this.ID));
                da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_ACTIONSsp_delete", _parameters.ToArray());
            }
            else
            {
                ...
                da = new DataAccess(authenticatedUserId, connectionString, CommandType.StoredProcedure, "UTILIZATORI_ACTIONSsp_deleteByFields", _parameters.ToArray());
            }
